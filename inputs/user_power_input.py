...
class UserPowerInputDef(Enum):
    ...
    battery_state_of_charge = Input(index=13, type=DataType.float, out_type=DataType.int, modbus_ref=40002, to_web_app=True)
    battery_error_number = Input(index=14, type=DataType.string)
    battery_error_location = Input(index=15, type=DataType.string)
    battery_max_temp = Input(index=16, type=DataType.int, modbus_ref=40007, to_web_app=True)
    ...
    solar_panels_panel_power_0 = Input(index=31, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_1 = Input(index=32, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_2 = Input(index=33, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_3 = Input(index=34, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_4 = Input(index=35, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_5 = Input(index=36, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_6 = Input(index=37, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_7 = Input(index=38, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_8 = Input(index=39, type=DataType.float, to_web_app=True)
    solar_panels_panel_power_9 = Input(index=40, type=DataType.float, to_web_app=True)

    driver_motor_temp = Input(index=41, type=DataType.float, out_type=DataType.int, modbus_ref=40008, to_web_app=True)
    driver_driver_temp = Input(index=42, type=DataType.float, out_type=DataType.int, modbus_ref=40009, to_web_app=True)
    driver_driver_output_power = Input(index=43, type=DataType.float, to_web_app=True)
    driver_motor_speed = Input(index=43, type=DataType.float, to_web_app=True)
    driver_driver_voltage_input = Input(index=45, type=DataType.float, to_web_app=True)
    driver_driver_current_input = Input(index=46, type=DataType.float, to_web_app=True)
    driver_driver_state = Input(index=47, type=DataType.bit, to_web_app=True)
    ...
    steer_raw_throttle = Input(index=69, type=DataType.string, to_web_app=True)
    steer_fly_mode = Input(index=70, type=DataType.string, to_web_app=True)
    steer_reverse = Input(index=71, type=DataType.bit)

    total_voltage = Input(index=72, type=DataType.float, to_web_app=True)
    total_current = Input(index=73, type=DataType.float, to_web_app=True)
    driver_on = Input(index=74, type=DataType.bit, to_web_app=True)
